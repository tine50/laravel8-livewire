        ...
        <div class="card card-primary">
            ...
            <form wire:submit.prevent="updateUser()">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Sexe</label>
                        <select name="" id="" wire:model="editUser.sexe"
                    ...
                    <div class="form-group">
                        ...
                        <select name="" id="" wire:model="editUser.pieceIdentite"
                                    ...
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <div
                                            ...
                                            <label class="custom-control-label"
                                                for="customSwitch{{ $role['role_id'] }}">{{ $role['active'] ? 'Activé' : 'Désactivé' }}</label>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                ...
                                                <label class="custom-control-label"
                                                    for="customSwitchPermission{{ $permission['permission_id'] }}">{{ $permission['active'] ? 'Activé' : 'Désactivé' }}</label>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
