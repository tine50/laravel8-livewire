            ...
            <div class="card">
                <div class="card-header bg-gradient-primary d-flex align-items-center">
                    ...
                    <div class="card-tools d-flex align-items-center">
                        <a class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddTypeArticleForm">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <input type="text"
                                            ...
                                            wire:keydown.enter="addNewTypeArticle" wire:model="newTypeArticleName">
...
<script>
    window.addEventListener("showEditForm", function(e) {
        Swal.fire({
            ...
            input: "text",
            // inputLabel: e.detail.typearticle,
